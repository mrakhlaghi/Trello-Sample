...
function TrelloBrandMenuItem() {
  return (
    <div className="flex justify-center items-center ">
      {/* <div className="parent-div flex justify-between items-start rounded-[3px] w-6 h-6 p-1 bg-white  ">
        <div className=" child-first w-[6px] h-[13px] rounded-[2px]  bg-[#333C43]"></div>
        <div className=" child-second w-[6px] h-[9px] rounded-[2px] bg-[#333C43]"></div>
      </div> */}
      <svg
        version="1.1"
        id="Calque_1"
...
export default TrelloBrandMenuItem;
